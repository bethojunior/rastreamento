					...
					<table cellspacing="6" cellpadding="0">
						...
						for ($i=0; $i < mysql_num_rows($resUsu); $i++) {
							...
							echo "<tr>";
								...
								if ($masterListaUsuarios == "N")
									echo "<button type='button' class='btn btn-sm md-skip dropdown-toggle' data-toggle='dropdown' data-hover='dropdown' data-close-others='true' title='Frota do cliente' alt='Frota do cliente' onclick='abrirFrotaCliente(". $rowUsu[id] .");' /> </a> <span class='badge'>". $rowUsu[qtFrota] ."</span></button></div></td>";
								else
