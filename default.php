...
<div class="col-lg-12" id="map-canvas"></div>	
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <div class="navbar-header">
        ...
        <a href="default.php" class="navbar-brand" title="Recarregar"><i class="fa fa-refresh fa-spin fa-fw margin-bottom"></i><span class="sr-only">Aguarde...</span></a> 
      </div>      	
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav navbar-right navbar-user">          
          ...
          <li class="dropdown veiculos-dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-truck" aria-hidden="true"></i> VEÍCULOS <b class="caret"></b></a>
          ...
          <?php if (empty($config) || $config->comandos): ?>
            <li class="dropdown comandos-dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-code"></i> COMANDOS <b class="caret"></b></a>
              <ul class="dropdown-menu text-center">
                <form id="comandos" class="form-inline" role="form">
                  ...
                  <!--<li class="divider"></li>-->
                  <button type="button" id="enviarcomando" class="btn btn-primary" disabled><i class="fa fa-upload"></i> EXECUTAR</button>
                </form>
              </ul>
            </li>
          <?php endif ?>
          ...
          <?php if (empty($config) || $config->cerca): ?>
            <li class="dropdown cerca-dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-thumb-tack" aria-hidden="true"></i></i> CERCA VIRTUAL <b class="caret"></b></a>
              <ul class="dropdown-menu text-center">
          ...
          <?php if (empty($config) || $config->rota): ?>
            <li class="dropdown cerca-dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-road" aria-hidden="true"></i> ROTAS <b class="caret"></b></a>
              <ul class="dropdown-menu text-center">
                <form class="form-inline" role="form">
                  <li><input type="text" class="form-control" id="inicio_rota" placeholder="De: Origem" required></li>
                  <!--<li class="divider"></li>--><p>
          ...
          <li class="dropdown alerts-dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> ALERTAS <span class="badge">0</span> <b class="caret"></b></a>
          ...
          <li class="dropdown user-dropdown">
            ...
            <ul class="dropdown-menu">
              <?php if (empty($grupo) && (empty($config) || $config->dados)): ?>
                <li><a href="#modal-dados" data-toggle="modal"><i class="fa fa-user" aria-hidden="true"></i> DADOS CADASTRAIS</a></li>
              <?php endif ?>
			  <li class="divider"></li>
              ...
              <?php if (empty($config) || $config->grupos): ?>
                <li class="divider"></li>
                <li><a href="#modal-grupos" data-toggle="modal"><i class="fa fa-users" aria-hidden="true"></i> GRUPOS</a></li>
              <?php endif ?>                
                <li class="divider"></li>                
    ...
    <div id="page-wrapper">
	  ...
	  <div class="modal fade" id="info-veiculo" role="dialog" style="margin-top: 60px;">
				<div class="modal-dialog">				  
				  <div class="modal-content">
					<div class="modal-header">					
					  <font color="#FFFFFF" face="Oswald"><h4 class="modal-title">INFORMAÇÕES DO VEÍCULO</font></h4>
					</div>
        ...
        <form method="GET" id="alterar-senha" class="form-horizontal" role="form">
          <div class="modal-body"> 
            <div class="form-group"> 
              ...
              <div class="col-lg-4"> 
                <label class="control-label" for="repita_senha">REPETIR NOVA SENHA</label>
  ...
  <script type="text/javascript">
	...
	var estadoIgnicao;
	  ...
	  $("button[rel=tooltip]").tooltip({ placement: 'left' });
	...
	*/
    ...
    interAutoReload = setInterval(autoReload, 10000);
