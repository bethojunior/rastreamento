...
<div class="row">
	...
	<div class="col-xs-12">
		<div class="col-xs-12" id="mapview"></div>
			<iframe src="/mapa.php" scrolling="no" name="mapa" id="mapa"></iframe>
		    <a href="javascript:void(0)" id="apagaTudo" style="font-size:14px; color:rgba(0, 0, 0, 0.9);">LIMPAR MARCADORES</a>
		</div>
		<div id="alertas"></div>
	</div>	
</div>
<div id="dialog_box">
	...
	<div class="content">
		...
		<b>Identificação: </b><span id="iApelido"></span><br>
		<b>Data Recarga: </b><span id="iRecarga"></span><br><hr>
		<b>DADOS DO CLIENTE&nbsp;</b><br><br>
		<b>Nome: </b><span id="iCliente"></span><br>
		<b>E-mail: </b><span id="iEmail"></span><br>
		<b>Telefone: </b><span id="iIdentificacao"></span><br>		
