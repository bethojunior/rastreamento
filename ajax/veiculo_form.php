...
<h5 align="justify"><strong>ATENÇÃO!</strong> Para Rastreadores Suntech digite somente os 6 penultimos digitos do IMEI, exemplo: XXXXXXXX123456X - Desconciderando os outros representado por "X".</h5>
...
<table id="tableEquip" class="equip table table-bordered table-striped">
    ...
    <tr><td colspan="2"><br><br>
        ...
        <img src="../imagens/delete.png" style="cursor:pointer" />
