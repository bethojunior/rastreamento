...
input.smallCheckbox {
	...
	<body onload="resizeDiv();initialize();updateMyKml(document.getElementById('nrImeiMapa').value);" onresize="resizeDiv();" onunload="">
		...
		VISUALIZAR TODOS OS <a style="color:#FFFFFF" href="/map_all_devices.php" target="_blank">VEÍCULOS</a>
	</div>
		
		<div id="map_canvas" style="width: 101%; height:768px ; float:left; border: 1px solid #c0c0c0; margin-top: -8px; margin-left:-8px; margin-right:0px" align="center"></div>
